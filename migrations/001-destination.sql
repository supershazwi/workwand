...
INSERT INTO Plan_Cost (content, planId) values ('75 SGD for each pass upon application', 6);
INSERT INTO Plan_Cost (content, planId) values ('100 SGD for each pass upon issuance', 6);

INSERT INTO Plan_Cost (content, planId) values ('105 SGD for each pass upon application', 7);
INSERT INTO Plan_Cost (content, planId) values ('225 SGD for each pass upon issuance', 7);
INSERT INTO Plan_Cost (content, planId) values ('30 SGD for each Multiple Journey Visa', 7);

INSERT INTO Source (page, name, link) values ('work-holiday-pass-under-work-holiday-programme-singapore', 'Ministry of Manpower | Work Holiday Pass (under Work Holiday Programme)', 'https://www.mom.gov.sg/passes-and-permits/work-holiday-programme');
INSERT INTO Source (page, name, link) values ('work-holiday-pass-under-work-and-holiday-visa-programme-singapore', 'Ministry of Manpower | Work Holiday Pass (under Work and Holiday Visa Programme)', 'https://www.mom.gov.sg/passes-and-permits/work-and-holiday-visa-programme');
INSERT INTO Source (page, name, link) values ('employment-pass-singapore', 'Ministry of Manpower | Employment Pass', 'https://www.mom.gov.sg/passes-and-permits/employment-pass');
INSERT INTO Source (page, name, link) values ('entrepass-singapore', 'Ministry of Manpower | EntrePass', 'https://www.mom.gov.sg/passes-and-permits/entrepass');
INSERT INTO Source (page, name, link) values ('personalised-employment-pass-singapore', 'Ministry of Manpower | Personalised Employment Pass', 'https://www.mom.gov.sg/passes-and-permits/personalised-employment-pass');
INSERT INTO Source (page, name, link) values ('s-pass-singapore', 'Ministry of Manpower | S Pass', 'https://www.mom.gov.sg/passes-and-permits/s-pass');
INSERT INTO Source (page, name, link) values ('training-employment-pass-singapore', 'Ministry of Manpower | Training Employment Pass', 'https://www.mom.gov.sg/passes-and-permits/training-employment-pass');
...
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (1, "Candidate submits an application", "Candidate", "8 weeks", "","In-principle approval letter or rejection letter", 5);
...
INSERT INTO Plan_Age_Eligibility (lower_bound_age, upper_bound_age, planId) values (18, 99, 6);

INSERT INTO Plan_Country_Eligibility (country, planId) values ("All", 6);

INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (1, "Employer or employment agency submits an application", "Employer or employment agency", "3 weeks", "","In-principle approval letter or rejection letter", 6);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (2, "Employer or employment agency requests for pass to be issued", "Employer or employment agency", "Immediate", "Within 60 days of in-principle approval","Notification letter", 6);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (3, "Candidate registers fingerprints and photo (if required)", "Candidate", "Immediate", "Within 1 week after pass is issued","Acknowledgment of card delivery", 6);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (4, "Candidate or authorised recipients receives the card", "Authorised recipients or candidate", "Immediate", "4 working days after registration or document verification","S Pass card", 6);

INSERT INTO Plan_Age_Eligibility (lower_bound_age, upper_bound_age, planId) values (18, 99, 7);

INSERT INTO Plan_Country_Eligibility (country, planId) values ("All", 7);

INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (1, "Employer submits an application", "Employer", "3 weeks", "","In-principle approval letter or rejection letter", 7);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (2, "Employer requests for pass to be issued", "Employer", "Immediate", "Within 6 months of in-principle approval","Notification le7ter", 7);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (3, "Candidate registers fingerprints and photo (if required)", "Candidate", "Immediate", "Within 2 weeks after pass is issued","Acknowledgment of card delivery", 7);
INSERT INTO Plan_Step (sequence, content, owner, processing_time, deadline, result, planId) values (4, "Candidate or authorised recipients receives the card", "Authorised recipients or candidate", "Immediate", "4 working days after registration or document verification","Traning Employment Pass card", 7);
